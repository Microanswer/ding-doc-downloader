module.exports = {
    ...
    render(h) {
        return h("li", {class: "dddd-dropdown dddd-dropdown-end"}, [
            h("div", {tabIndex:"0", role:"button", class: "flex flex-row justify-between items-center px-3 py-1 bg-base-200 rounded-sm hover:bg-base-300"}, [
                h("div", {class: "text-sm"}, this.title),
                h("div", {class: "text-base-content/60"}, [
            ...
            h("ul", {tabIndex: "0", class: "dddd-dropdown-content dddd-menu bg-base-200 border border-zinc-400 rounded-box w-56 shadow-md"}, this.options.map(op =>
                h("li", {class: "hover:bg-base-300 rounded-sm"}, [
